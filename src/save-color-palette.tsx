...
export default function Command(props: SavePaletteFormProps) {
  ...
  /// TODO in launchContext there could be colors generated through AI
  /// basically the form could be automatically filled with colors generated by create-colors-with-ai
  /// if in the end you do not implement it, you should change this
